...
<h1 class="text-center">
  ...
  <a href="onlinepay.php"><button class="btn btn-success"><span class="glyphicon glyphicon-credit-card"></span> Pay Online[Available soon]</button></a>
  <a href="COD.php"><button class="btn btn-success"><span class="glyphicon glyphicon-"></span> Cash On Delivery</button></a>
  <a href="address.php"><button class="btn btn-warning"><span class="glyphicon glyphicon-"></span> Update address</button></a>
</h1>
